      ...
      <header className="sticky top-0 z-50 bg-slate-900/80 backdrop-blur-sm border-b border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="text-2xl font-bold text-white">The Koru Project</div>
            <Button aria-label="Schedule Free Consultation" className="bg-blue-600 hover:bg-blue-700 text-white">
      ...
      <main id="main">
        ...
        <section className="relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">Personal AI That Knows You</h1>
            <p className="text-2xl md:text-4xl text-blue-300 mb-2">Private AI for Every Part of Life</p>
            <p className="text-xl text-slate-300 mb-6">Personal • Family • Business</p>
        ...
        <section className="py-20 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-6">Personal AI for Every Aspect of Life</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                ...
                <p className="text-slate-400">A private health companion that learns from your medical history, preferences, and goals.</p>
              </div>
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                <h3 className="text-xl font-semibold text-white mb-4">Family Tutor AI →</h3>
                <p className="text-slate-400">Personalized tutoring for your children, adapting to their pace and style.</p>
              </div>
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                <h3 className="text-xl font-semibold text-white mb-4">Financial Advisor AI →</h3>
                <p className="text-slate-400">Guidance based on your real financial habits and goals.</p>
              </div>
            </div>

            <div className="text-center mt-12">
              <div className="bg-green-900/30 border border-green-700 rounded-lg p-6 max-w-2xl mx-auto">
                <p className="text-green-300 font-semibold">🔒 All solutions run in your isolated environment — your data stays with you.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-300">Choose the right solution for your needs — from personal environments to ready-made agents to enterprise consulting.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                ...
                <p className="text-slate-400 mb-6">Your own private AI environment that learns from personal docs, family photos, and knowledge.</p>
              ...
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                ...
                <p className="text-slate-400 mb-6">Pre-trained, plug-and-play AI agents for specific tasks.</p>
                <div className="space-y-2 mb-6">
              ...
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                ...
                <p className="text-slate-400 mb-6">Professional AI implementation using:</p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-red-900/20 border border-red-700 p-8 rounded-lg">
                ...
                <p className="text-slate-400">No one wants family photos or business secrets training big-tech models.</p>
              </div>
              <div className="bg-red-900/20 border border-red-700 p-8 rounded-lg">
                <h3 className="text-xl font-semibold text-red-300 mb-4">Generic Responses →</h3>
                <p className="text-slate-400">Cloud AIs don't know your docs, business, or family context.</p>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700 text-center">
                ...
                <p className="text-slate-400">30-minute consultation to choose the right solution.</p>
              </div>
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700 text-center">
                <div className="text-4xl mb-4">2️⃣</div>
                <h3 className="text-xl font-semibold text-white mb-4">Setup & Installation</h3>
                <p className="text-slate-400">We configure your isolated environment, install LLM + RAG, and optimize it with your documents.</p>
              </div>
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700 text-center">
                <div className="text-4xl mb-4">3️⃣</div>
                <h3 className="text-xl font-semibold text-white mb-4">Training & Handoff</h3>
                <p className="text-slate-400">Live training, full documentation, 30 days of support. You own it completely.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Get AI that truly understands you, your family, or your business.</p>
